...
状态：待执行。代码基线为 `0acd823e7e67684ae4fa9d50fa63aed5fd7f8629`；
本轮只修订文档，不改变程序。云端浏览器无法访问本地服务，本清单用于在运行
Waitress 的 Windows 电脑上，由人工或可正常连接该页面的受支持浏览器能力执行。
不得把 API/Node 测试结果填写为真实浏览器通过。
